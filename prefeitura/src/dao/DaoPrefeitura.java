...
public class DaoPrefeitura {
     public static boolean inserir(Prefeitura objeto) {
        String sql = "INSERT INTO prefeitura (nome, endereco, nrdefuncionario) VALUES (?, ?, ?)";
        try {
            PreparedStatement ps = conexao.Conexao.getConexao().prepareStatement(sql);
            ps.setString(1, objeto.getNome());
            ps.setString(2, objeto.getEndereco());
            ps.setInt(3, objeto.getNrdefuncionario());
            ps.executeUpdate();
            return true;
     ...
     public static void main(String[] args) {
        ...
        objeto.setNome("Joao");
        objeto.setEndereco("Rua tal");
        objeto.setNrdefuncionario(21);
       ...
       public static boolean alterar(Prefeitura objeto) {
        String sql = "UPDATE prefeitura SET nome = ?, endereco = ?, nrdefuncionario = ? WHERE codigo=?";
        try {
            PreparedStatement ps = conexao.Conexao.getConexao().prepareStatement(sql);
            ps.setString(1, objeto.getNome()); 
            ps.setString(2, objeto.getEndereco());
        ...
        try {
            ...
            while (rs.next()) {
                ...
                objeto.setNrdefuncionario(rs.getInt("nrdefuncionario"));
